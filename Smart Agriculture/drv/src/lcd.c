...
#define LCD_DATA_MASK 	(1<<BIT25) | (1<<BIT24) | (1<<BIT23) | (1<<BIT22) | (1<<BIT21) | (1<<BIT20) | (1<<BIT19) | (1<<BIT18)
...
{
	IO1CLR = LCD_DATA_MASK;
	IO1SET = (lcd_data<<18)&(LCD_DATA_MASK);
}
...
void Init_LCD(void)
{
	...
	Set_LCD_Command(0x38);   // 4-bit interface, two line, 5X7 dots.        
