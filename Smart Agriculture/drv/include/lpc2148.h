...
typedef struct
{
	...
	unsigned int	P0_8: 2;	
	unsigned int	P0_9: 2;	
	unsigned int	P0_10:2;	
	unsigned int	P0_11:2;	
	unsigned int	P0_12:2;	
	unsigned int	P0_13:2;	
	unsigned int	P0_14:2;	
	unsigned int	P0_15:2;	
}pcb0_t;

typedef struct
{
	unsigned int	P0_16:2;	
	unsigned int	P0_17:2;	
	unsigned int	P0_18:2;	
	unsigned int	P0_19:2;	
	unsigned int	P0_20:2;	
	unsigned int	P0_21:2;	
	unsigned int	P0_22:2;	
	unsigned int	P0_23:2;	
	unsigned int	P0_24:2;	
	unsigned int	P0_25:2;	
	unsigned int	P0_26:2;	
	unsigned int	P0_27:2;	
	unsigned int	P0_28:2;	
	unsigned int	P0_29:2;	
	unsigned int	P0_30:2;	
	unsigned int	P0_31:2;	
}pcb1_t;

typedef struct
{
	unsigned int	RESERVED1	:2;	
	unsigned int	P1_36_26	:1;	
	unsigned int	P1_25_16	:1;	
